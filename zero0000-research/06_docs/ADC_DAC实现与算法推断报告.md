...
| ① 采样/更新率 | **双先验** A: ADC245.76/DACCLK491.52；**B(Conserviss实测)**: 双路245.76+DAC 2x→122.88 数据率；旁支 R5b：61.44 / 163.84(÷3)；**未测** | ❓（先验 🔶） |
...
- **RHINO 旁支（R5b）**：61.44 / 122.88 / **163.84(=491.52÷3)** / 245.76——G2 族识别已覆盖；**非**本板默认先验  
- TSW4200 支持 ADC 245.76；**不得默认 DACCLK=491.52**  
- G2-2 测 C2/C3（及 C6 DATACLK→插值比）裁决 A/B（或旁支）  
