...
- **采样域同源**：CDCE72010 以 X1 491.52 MHz VCXO 闭环（外参考经 CLK_IN 进入 PRI/SEC_REF），分频输出到 ADS62P49、DAC3283 与 FPGA 采样逻辑。491.52/2 = 245.76 MHz，恰在 ADS62P49 最大 250 MSPS 之内；DAC3283（≤800 MSPS）可用 491.52 MHz 或其倍/分频。
