...
namespace Aetherboard.VR
{
    ...
    public static class BattlePrefabLibrary
    {
        ...
        public const string BossMarkerPath = "Aetherboard/BossMarker";
        ...
        private static GameObject _bossMarker;
        ...
        public static GameObject BossMarkerPrefab
        {
            get
            {
                Probe();
        ...
        private static void Probe()
        {
            ...
            _bossMarker = Resources.Load<GameObject>(BossMarkerPath);
        }
    }
}
