...
MEATYPE_IDS = [f"ACQ-E1-MEATYPE-{n}" for n in (
    "LINEAR", "ANGULAR", "STR", "SQU", "PAR", "ROT", "WAY", "FLA", "DIA", "LTB", "ATB", "STB", "SINGLE", "DUAL"
)]
CMD_IDS = [
...
STATUS_IDS = [f"ACQ-E1-STATUS-{n}" for n in (
    "ACTIVEWINDOW", "5519ABREADY", "E1735AREADY", "E1735ACOUNT", "E1736AREADY", "E1736ACOUNT",
    "E1737ACOUNT", "E1738ACOUNT", "55290BREADY", "BEAMSTRENGTH", "MEASURESETUPOK",
    "HASERRORMESSAGE", "ERRORMESSAGE", "ISMEASURING", "SAMPLECOUNT", "ACCOMPLISHED",
    "UPPERDISPLAY", "LOWERDISPLAY", "UPPERSELECTION", "LOWERSELECTION", "UPPERUNITS",
    "LOWERUNITS", "UPPERSTRING", "LOWERSTRING", "CURRENTCYCLE", "CURRENTAXIS",
    "NEXTDIRECTION", "NEXTINDEX", "NEXTTARGET",
)]
# E1735A.dll 导出符号
...
ACQ_ENTRY_IDS = MEATYPE_IDS + CMD_IDS + TRIG_IDS + STATUS_IDS + DLL_IDS + CORE_IDS + UNK_IDS
