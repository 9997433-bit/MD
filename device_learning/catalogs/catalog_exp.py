...
ENTRIES = [
    ...
    _e("EXP-002-USB-ENUM", "capture", "Capture USB enumeration traffic", "not_started", "Need device+host", "phase_b/templates/usb_capture.md"),
    _e("EXP-003-USB-SESSION", "capture", "Capture config+acquire session", "not_started", "Need official driver", "phase_b/templates/usb_capture.md"),
    ...
    _e("EXP-013-ENDPOINT-MAP", "analysis", "Map bulk IN/OUT endpoint numbers", "not_started", "Depends EXP-002", "PROTO-EP-MAP"),
