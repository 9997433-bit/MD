...
ENTRIES = [
    ...
    _e("LEARN-011-8051-DISASM", "topic", "8051 firmware reverse engineering", "candidate", "Lite disasm+xrefs on volatile RAM; full Ghidra CFG and eeprom.bin still open", "mcu_disasm.txt + fx2_ram_xrefs.json + fx2_oracle_crosscheck.json"),
