...
| ID | 状态 | 原因 |
|----|------|------|
| FRM-011~020 | **candidate/confirmed** | `scan_spartan3_frames.py` / `frame_deep.json` 已交付 FAR 解码与寄存器统计 |
| FRM-006, FRM-008, FRM-009 | unknown | 完整逐帧地址重建未实现 |
| IOB-002~004, IOB-008~015 | unknown | IOB 配置字解码未闭合 |
| CLK-001~005 | unknown | 时钟网络需帧级分析 |
| MEM-001~003, MEM-005 | unknown | BRAM 初始化数据未提取 |
